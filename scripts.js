const showAllButon = document.querySelector ('.show-all')
...
list.innerHTML = `
<li>A soma de todos itens do menu é: <p class= "price"> ${format(totalValue)}</p></li>
`
}
...
showAllButon.addEventListener('click',()=> showAll (menuOptions))
